...
<div class="x_panel">
  <div class="x_title"><h2>Nombre Comercial</h2>
    <div class="clearfix"></div>
  </div>
  <div class="x_content">
    @include('Trasversal.Boton.botonCrud', ['href' => "/franquicia/create", 'clase' => "index"])
        ...
        <table cellpadding="3" class="table-filter" cellspacing="0" border="0" style="width: 100%; margin: 30px 10px;">
            <tbody>
                ...
                <tr id="filter_col2" data-column="2">
                    <td>Código<input type="text" maxlength="2" class="column_filter form-control justNumbers" id="col2_filter"></td>
                </tr>

                 <tr id="filter_col3" class="no-width" data-column="3">
                    <td>
...
@section('javascript')   
  @parent
   column=[
            { "data": "pais" },           
            { "data": "codigo_franquicia" },
            { "data": "nombre" },
            { "data": "estado" },
        ];
  	dataTableActionFilter("{{url('/franquicia/get')}}","{{url('/plugins/datatable/DataTables-1.10.13/json/spanish.json')}}",column)
