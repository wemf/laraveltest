    ...
    <body>
        ...
        <td>
            <div class="documento-pdf">
                ...
                <h5 class="font-medium" align="center">PRORROGA DE RETROVENTA DE CONTRATO</h5>
                ...
                <table class="tabla-detalle">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Valor prórroga:</td>
                            <td>{{ $object[0]->valor_ingresado_prorroga }}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <p class="font-small justify">
                    Manifestamos que por medio del presente documento MODIFICAMOS EXPRESAMENTE LA CLAUSULA TERCERA DEL CONTRATO DE COMPRAVENTA 
                    CON PACTO DE RETROVENTA, al CONTRATO N° {{ $object[0]->cod_contrato_bar }}; en cuanto al termino dentro del cual, EL VENDEDOR se reserva la facultad de 
                    recobrar elarticulo descrito en el contrato inidcado; para lo cual, dicho termino quedara asi:
                </p>
                <p class="font-medium"><strong>Fecha inicio contrato: {{ Carbon\Carbon::parse($object[0]->fecha_creacion)->format('d/m/Y') }} Prorrogado hasta: {{ Carbon\Carbon::parse($object[0]->fecha_terminacion_prorroga)->format('d/m/Y') }}</strong></p>
                <p class="font-medium"><strong>Fecha nuevo vencimiento: {{ Carbon\Carbon::parse($object[0]->fecha_terminacion_prorroga)->format('d/m/Y') }} Término: {{ $object[0]->termino }}</strong></p>
                <p class="font-medium"><strong>Cantidad histórica de prórrogas canceladas: {{ $object[0]->numero_prorrogas }}</strong></p>
                <p class="font-medium"><strong>Término: {{ $object[0]->termino }}</strong></p>
                <p class="font-small justify">
