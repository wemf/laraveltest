...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form id="form-attribute" action="{{ url('ciudad/update') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->nombre }}" maxLength='50' type="text" name="nombre" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->codigo_dane }}" maxLength='5' type="text" name="codigo_dane" required="required" class="form-control col-md-7 col-xs-12 justNumbers">
            </div>
          </div> 
