...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form id="form-attribute" action="{{ url('profesion/update') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->name }}" type="text" name="name" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->nit }}" type="text" name="nit" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->regime }}" type="text" name="regime" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
              ...
              <a href="{{ url('/profesion') }}" class="btn btn-danger" type="button">Cancelar</a>
            </div>
          </div>
        </form>
      </div>
...
@section('javascript')
    ...
    loadSelectInput("#id_city","{{ url('/ciudad/getSelectList') }}")  
    loadSelectInput("#id_franchise","{{ url('/franquicia/getSelectList') }}")  

    $('#id_franchise').val({{ $attribute->id_franchise }});
    $('#id_country').val({{ $attribute->id_country }});
    $('#id_province').val({{ $attribute->id_province }});
    $('#id_city').val({{ $attribute->id_city }});
