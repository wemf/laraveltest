...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form id="form-attribute" action="{{ url('zona/update') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->nombre }}" id="nombre" type="text" maxlength="30" name="nombre" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
