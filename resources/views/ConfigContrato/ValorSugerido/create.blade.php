...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      <div class="x_title">
        <h2>Nuevo precio sugerido</h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <br />
        <form id="form-valorsugerido" action="{{ url('configcontrato/valorsugerido/store') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group">
                ...
                <input type="text" class="moneda form-control centrar-derecha rem" name="valor_minimo_x_1" id="valor_minimo_x_1" maxlength="15" aria-label="Amount (to the nearest dollar)" required disabled>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group">
                <span class="input-group-addon">$</span>
                <input type="text" class="moneda form-control centrar-derecha rem" name="valor_maximo_x_1" id="valor_maximo_x_1" maxlength="15" aria-label="Amount (to the nearest dollar)" required disabled>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group">
                <span class="input-group-addon">$</span>
                <input type="text" class="moneda form-control centrar-derecha rem" name="valor_x_1" id="valor_x_1" maxlength="15" aria-label="Amount (to the nearest dollar)" required disabled>
              </div>
            </div>
          </div>
          ...
          <div class="form-group hide">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group">
                <span class="input-group-addon">$</span>
                <input type="text" class="moneda form-control centrar-derecha rem" name="valor_venta_x_1" id="valor_venta_x_1" maxlength="15" aria-label="Amount (to the nearest dollar)" disabled>
              </div>
            </div>
          </div>
