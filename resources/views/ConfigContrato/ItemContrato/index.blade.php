...
<div class="x_panel">
    <div class="x_title">
        <h2>Configuración de Items para Contrato</h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <div class="btn-group pull-right espacio" role="group" aria-label="...">
            <a href="{{ url('/configcontrato/itemcontrato/create') }}" title="Agregar Nuevo Registro" type="button" class="btn btn-success"><i class="fa fa-plus  "></i> Nuevo</a>
        ...
        <div class="contentfilter-table">
            <table cellpadding="3" class="table-filter" cellspacing="0" border="0" style="width: 100%; margin: 30px 10px;">
                <tbody>
                    ...
                    <tr>
                        <td><button type="button" onclick="intercaleFunction('col1_filter');" class="btn btn-primary button_filter"><i class="fa fa-search"></i> Buscar</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
@endsection @section('javascript') @parent column=[ { "data": "categoria" }, { "data": "estado" }, ]; dataTableActionFilter("{{url('/configcontrato/itemcontrato/get')}}","{{url('/plugins/datatable/DataTables-1.10.13/json/spanish.json')}}",column);
loadSelectInput("#col0_filter", "{{url('/products/categories/getCategory')}}",2); 
$("#updateAction1").click(function() {var url2="{{ url('/configcontrato/itemcontrato/edit') }}"; updateRowDatatableAction(url2) }); 
$("#deletedAction1").click(function(){ var url2="{{ url('/configcontrato/itemcontrato/inactive') }}"; deleteRowDatatableAction(url2); }); 
$("#deletedAction2").click(function(){ var url2="{{ url('/configcontrato/itemcontrato/delete') }}"; deleteRowDatatableAction(url2, "¿Eliminar el registro?"); }); 
$("#activatedAction1").click(function() { var url2="{{ url('/configcontrato/itemcontrato/active') }}"; deleteRowDatatableAction(url2, "¿Activar el registro?"); });
@endsection