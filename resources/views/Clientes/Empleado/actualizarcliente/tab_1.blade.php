...
<div class="row">	
	...
	<div class="col-md-6 col-xs-12">	
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Fecha Expedición<span class="required">*</span>
				...
				<div class="col-xs-8">
					...
					@else
					<input readonly type="text" name="fecha_expedicion" value="{{$attribute->fecha_expedicion}}" class="form-control  requiered data-picker-until-today">
					@endif
				</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-4">País de Expedición <span class="required">*</span>
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Nombre Completo<span class="required">*</span>
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Género<span class="required">*</span>
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Estado Civil<span class="required">*</span>
			</label>
			<div class="col-xs-8">
	...
	<div class="col-md-6 col-xs-12">	
		<div class="form-group">
			...
			<div class="col-xs-8">
				<input readonly id="fecha_nacimiento" name="fecha_nacimiento" value="{{$attribute->fecha_nacimiento}}" class="form-control  data-picker-until-today">
			</div>
		</div> 
		<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Barrio Residencia<span class="required">*</span>
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Teléfono Residencia<span class="required">*</span>
			</label>
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Talla Camisa<span class="required">*</span>
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Talla Pantalón<span class="required">*</span>
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Talla Zapatos<span class="required">*</span>
			</label>
			<div class="col-xs-8">
...
@section('javascript')   
    ...
    $(document).ready(function()
    {
      ...
      @endif
		...
		@if(!($attribute->id_tipo_cliente != 1) || !($attribute->id_tipo_cliente != 2) )
        $('#id_tipo_cliente').val({{$attribute->id_tipo_cliente}});
		@endif
        $('#id_tipo_cliente').change();		
