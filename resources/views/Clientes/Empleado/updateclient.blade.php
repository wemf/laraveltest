...
<div class="col-md-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Actualizar Cliente a Empleado</h2>
        ...
        <form id="form-attribute" action="javascript:void(0)" method="POST" class="form-horizontal form-label-left">
          ...
          <div id="tabs">
            ...
            <div id="tabs-1" class="contenido-tab">
              @include('Clientes/Empleado/actualizarcliente/tab_1')  
            </div>
            <div id="tabs-2" class="contenido-tab">
              @include('Clientes/Empleado/actualizarcliente/tab_2')  
            </div>
            <div id="tabs-3" class="contenido-tab">
              @include('Clientes/Empleado/actualizarcliente/tab_3')  
            </div>
            <div id="tabs-4" class="contenido-tab">  
              @include('Clientes/Empleado/actualizarcliente/tab_4')  
            </div>
            <div id="tabs-5" class="contenido-tab">
              @include('Clientes/Empleado/actualizarcliente/tab_5')  
            </div>
            <div id="tabs-6" class="contenido-tab">
              @include('Clientes/Empleado/actualizarcliente/tab_6')  
            </div>  
