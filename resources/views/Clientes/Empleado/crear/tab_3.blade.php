<div class="form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12" id="check_familia">
    <input type="radio" name="familiares_en_nutibara" onclick="requiredChecked('valCheck',1)" value="1">Sí
    <input type="radio" name="familiares_en_nutibara" onclick="requiredChecked('valCheck',0)" value="0">No
    <input type="hidden" name="familiares_en_nutibara" id="valCheck" class="requiered">
  </div>
</div>
<div class="panel panel-primary" style="overflow: scroll; opacity:0.4;" id="panel-familiares-nutibara">
  ...
  <div class="panel-body">
    ...
    <br>
    <button type="button" class="btn btn-info btn-agregar-fila" class=" col-md-12">Agregar</button>
    <table class="table table-striped table-bordered table-hover dataTables-example3 tbl-contenido" id="dataTable" >
      ...
      <tbody>
        <tr class="tr-contenido">
          <td>
            <input type="hidden" name="id_tienda_pariente[]" class="hd_id_tienda_pariente" >
            <input type="hidden" name="codigo_cliente_pariente[]" class="hd_codigo_cliente_pariente" >
            <select disabled="disabled" name="id_tipo_documento_parientes[]" class="form-control col-md-7 col-xs-12 tipo_documento">
              <option value="">- Seleccione una opción -</option>
              @foreach($tipo_documento as $tipo)
                <option value="{{ $tipo->id }}">{{ $tipo->name }}</option>
              @endforeach  
          ...
          <td><input disabled="disabled" name="identificacion_parientes[]" maxlength="12" class="form-control col-md-3" ></td>
          <td class="td-contenido">
            @if(Request::old('nombre_parientes'))
              <input disabled="disabled" type="text" name="nombre_parientes[]" class="form-control col-md-7 col-xs-12"  min="0" value="{{Request::old('nombre_parientes')}}">
            @else
              <input disabled="disabled" type="text" name="nombre_parientes[]" class="form-control col-md-7 col-xs-12"  min="0">
            @endif  
          </td>
          <td>
              <input disabled="disabled" type="text" name="fecha_nacimiento_parientes[]" class="form-control col-md-7 col-xs-12 data-picker-only"  min="0" value="{{Request::old('fecha_nacimiento_parientes')}}"> 
          </td>
          <td>
            <select disabled="disabled" name="id_tipo_parentesco[]" class="id_tipo_parentesco form-control col-md-7 col-xs-12" >
              <option value="">- Seleccione una opción -</option>
          ...
          <td>
            <select disabled="disabled" name="id_cargo_pariente[]" class="form-control col-md-7 col-xs-12 id_cargo_empleado" >
              <option value="">- Seleccione una opción -</option>
          ...
          <td>
            <select disabled="disabled" name="ciudad_pariente[]" class="form-control col-md-7 col-xs-12 id_ciudad">
              <option value="">- Seleccione una opción -</option>
        ...
        <tbody>
            <tr class="tr-contenido">
                ...
                <td>
                  ...
                  <input type="hidden" name="hd_beneficiario[]" class="col-md-2 check">
                </td>
                <td>
...
<div class="panel panel-primary" style="overflow: scroll;">
  ...
  <div class="panel-body">
    ...
    <table class="table table-striped table-bordered table-hover dataTables-example3 tbl-contenido" style="overflow: scroll;width: 2500px;" id="dataTable">
      <thead>
        <tr class="">
          <th <span class="required">*</span>>Tipo de Documento<span class="required">*</span></th>
          <th <span class="required">*</span>>Número de Documento<span class="required">*</span></th>
          <th <span class="required">*</span>>Nombres<span class="required">*</span></th>
          <th <span class="required">*</span>>Primer Apellido<span class="required">*</span></th>
          <th>Segundo Apellido</th>
          <th>Parentesco</th>
          <th>Dirección</th>
          <th>Ciudad</th>
          <th <span class="required">*</span>>Teléfono</th>
          <th>Borrar</th>
        </tr>
      </thead>
      <tbody>
        <tr class="tr-contenido">
          ...
          <td><input type="text" name="direccion_emergencia[]" id="direccion_emergencia_1" class="form-control col-md-2 direccion"  data-post="1"></td>
          <td>
...
<div class="center">
  ...
  <button type="button" class="btn btn-success btn-recorrido3" data-id-div="tabs-3" data-href="tabs-4" next="ui-id-4">Siguiente <i class="fa fa-angle-right" aria-hidden="true"></i> </button>
</div>