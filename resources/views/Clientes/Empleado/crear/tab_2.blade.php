...
<div class="row">	
    <div class="col-md-6 col-xs-12">	
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <select id="id_contrato" name="id_contrato" class="id_contrato form-control requiered obligatorio">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <!-- <input type="text" id="id_salario" name="salario" maxlength="12" class="form-control requiered obligatorio numeric"> -->
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <input type="text" class="moneda form-control centrar-derecha" name="id_salario" id="id_salario" maxlength="15" aria-label="Amount (to the nearest dollar)">
                </div>
            </div>
        </div> 
        <div class="form-group">
            ...
            <div class="col-xs-8">
                ...
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <input type="text" class="moneda form-control centrar-derecha" name="id_valor_auxilio_vivenda" id="id_valor_auxilio_vivenda" maxlength="15" aria-label="Amount (to the nearest dollar)">
                </div>
            </div>
        </div> 
        <div class="form-group">
            ...
            <div class="col-xs-8">
                ...
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <input type="text" class="moneda form-control centrar-derecha" name="id_valor_auxilio_transporte" id="id_valor_auxilio_transporte" maxlength="15" aria-label="Amount (to the nearest dollar)">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <input readonly id="fecha_ingreso" name="fecha_ingreso" class="form-control data-picker-only obligatorio requiered">
            </div>
        </div> 
    ...
    <div class="col-md-6 col-xs-12">	
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <select id="id_eps" name="id_eps" class="form-control id_eps obligatorio requiered">
                    <option value="">- Seleccione una opción -</option>
                    @foreach($eps as $tipo)
                    <option value="{{ $tipo->id }}">{{ $tipo->name }}</option>
                    @endforeach  
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <select id="id_caja_compensacion" name="id_caja_compensacion" class="form-control obligatorio requiered">
                    <option value="">- Seleccione una opción -</option>
