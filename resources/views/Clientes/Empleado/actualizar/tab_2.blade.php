...
<div class="row">	
    <div class="col-md-6 col-xs-12">	
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <input readonly id="fecha_ingreso" name="fecha_ingreso" value='{{dateFormate::ToFormatInverse("$attribute->fecha_ingreso")}}' class="form-control data-picker-only obligatorio obligatorio requiered">
            </div>
        </div> 
