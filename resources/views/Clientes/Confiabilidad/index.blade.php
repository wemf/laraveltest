...
<div class="x_panel">
  <div class="x_title">
    <h2>Niveles de Confiabilidad</h2>
    <div class="clearfix"></div>
  </div>
  <div class="x_content">
    @include('Trasversal.Boton.botonCrud', ['href' => "/clientes/confiabilidad/create"])
...
@section('javascript')   
  @parent
   column=[           
            { "data": "nombre" },
            { "data": "permitir_contrato" },
            { "data": "estado" },
        ];
  	dataTableActionFilter("{{url('/clientes/confiabilidad/get')}}","{{url('/plugins/datatable/DataTables-1.10.13/json/spanish.json')}}",column)

    $("#updateAction1").click(function() {
      var url2="{{ url('/clientes/confiabilidad/update') }}";
      updateRowDatatableAction(url2)
    });

    $("#deletedAction1").click(function() { 
      var url2="{{ url('/clientes/confiabilidad/delete') }}";
      deleteRowDatatableAction(url2);
    });

    $("#activatedAction1").click(function() { 
      var url2="{{ url('/clientes/confiabilidad/active') }}";
