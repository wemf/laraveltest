...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      <div class="x_title">
        <h2>Actualizar Denominación de Moneda</h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <br />
        <form id="form-attribute" action="{{ url('/clientes/denominacionmoneda/update') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="nombre" required="required" maxlength="20" class="form-control col-md-7 col-xs-12" value='{{$attribute->denominacion}}'>
            </div>
          </div> 
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="valor" required="required" maxlength="20" class="form-control col-md-7 col-xs-12 moneda" value='{{$attribute->valor}}'>
            </div>
          </div> 
          ...
          <div class="form-group">
            <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
              ...
              <a href="{{ url('/clientes/denominacionmoneda') }}" class="btn btn-danger" type="button">Cancelar</a>
            </div>
          </div>
        </form>
      </div>
