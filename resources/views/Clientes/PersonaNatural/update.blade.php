...
<div class="col-md-11" style="float:none !important;">
  @include('Trasversal.migas_pan.migas')
    <div class="x_panel">
      <div class="x_title">
        <h2>Actualizar Cliente Persona Natural</h2>
        ...
        <form id="form-attribute" action="javascript:void(0)" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
          ...
          <div id="tabs">
            ...
            <div id="tabs-1" class="contenido-tab">
              @include('Clientes/PersonaNatural/actualizar/tab_1')  
            </div>
            {{-- <div id="tabs-2" class="contenido-tab">
              @include('Clientes/PersonaNatural/actualizar/tab_2')  
            </div>
            <div id="tabs-3" class="contenido-tab">
              @include('Clientes/PersonaNatural/actualizar/tab_3')  
            </div>
            <div id="tabs-4" class="contenido-tab">
              @include('Clientes/PersonaNatural/actualizar/tab_4')  
            </div> --}}
          </div>    
          <br>
          ...
          <div class="form-group">
            <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
              ...
              <a href="{{ url('/clientes/persona/natural') }}" class="btn btn-danger" type="button">Cancelar</a>
            </div>
          </div>
