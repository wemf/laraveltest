...
<div class="center">
    <button type="button" class="btn btn-primary btn-recorrido" data-id-div="tabs-3" next="ui-id-2" data-anterior="1" data-href="tabs-2"><i class="fa fa-angle-left" aria-hidden="true"></i> Anterior</button>
    <button type="button" class="btn btn-success btn-recorrido" data-id-div="tabs-3" next="ui-id-4" data-href="tabs-4">Siguiente <i class="fa fa-angle-right" aria-hidden="true"></i> </button>
</div>
