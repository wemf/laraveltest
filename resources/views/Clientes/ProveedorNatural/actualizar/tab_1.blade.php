<div class="row">	
	...
	<div class="col-md-6 col-xs-12">
			...
			<div class="form-group">
				...
				<div class="col-xs-8">
					<select id="id_franquicia" data-load="{{ $attribute->id_franquicia }}"  name="id_franquicia" disabled class="form-control requiered" readonly>
					</select>
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<select id="id_sociedad" name="id_sociedad" data-load="{{ $attribute->id_sociedad }}" disabled class="form-control  requiered" readonly>
				</select>
			</div>
		</div> 
		<div class="form-group">
			...
			<div class="col-xs-8">
				<select id="id_tienda" name="id_tienda" data-load="{{ $attribute->id_tienda }}" disabled class="form-control  requiered" readonly>
				</select>
			</div>
		</div> 
	</div>
	<div class="col-md-6 col-xs-12">	
		<div class="form-group">
			<label class="control-label col-xs-4">País
			</label>
			<div class="col-xs-8">
				<select id="id_pais_trabajo" data-load="{{ $attribute->id_pais_trabajo }}" class="form-control  id_pais" disabled></select>
			</div>
		</div> 
		<div class="form-group">
			<label class="control-label col-xs-4">Departamento
			</label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<select id="id_ciudad_trabajo" class="form-control  requiered" disabled></select>
			</div>
		</div>  
	</div>
</div>
<div class="row">	
	...
	<div class="col-md-6 col-xs-12">	
		<div class="form-group">
			...
			<div class="col-xs-8">
				<select id="id_tipo_documento" required data-load="{{ $attribute->id_tipo_documento }}" name="id_tipo_documento" class="form-control  requiered">
				</select>
			</div>
		</div> 
		<div class="form-group">
			...
			<div class="col-xs-8">
				<input type="text" required id="numero_documento" name="numero_documento" maxlength="12" value="{{$attribute->numero_documento}}" class="form-control  requiered ver_doc">
			</div>
		</div>		
		<div class="form-group">
			<label class="control-label col-xs-4">Fecha Expedición</label>
				<div class="col-xs-8">
					...
					<input type="text"  name="fecha_expedicion" class="form-control  requiered data-picker-until-today" value="{{Request::old('fecha_expedicion')}}" autocomplete="off">
					@else
					<input type="text"  name="fecha_expedicion" value="{{$attribute->fecha_expedicion}}" class="form-control  requiered data-picker-until-today" autocomplete="off">
					@endif
				</div>
			</div>
		<div class="form-group">
			...
			<div class="col-xs-8">
				<select id="id_pais_exp"  data-load="{{ $attribute->id_pais_expedicion }}" onchange="clearSelects([['id_dep_exp', 'delete_options'], ['id_ciu_exp', 'delete_options']], 1); loadSelectChild(this, '#id_dep_exp', '{{ url('/departamento/getdepartamentobypais') }}');" name="id_pais_expedicion" type="text" class="form-control requiered id_pais_parametro id_pais" data-sufijo="exp">
				</select>
			</div>
		</div> 
		<div class="form-group">
			...
			<div class="col-xs-8">
				<select id="id_dep_exp"  type="text" data-load="{{ $attribute->id_departamento_expedicion }}" onchange="clearSelects([['id_ciu_exp', 'delete_options']], 1); loadSelectChild(this, '#id_ciu_exp', '{{ url('/ciudad/getciudadbydepartamento') }}');" class="form-control  id_departamento "></select>
			</div>
		</div> 
		<div class="form-group">
			...
			<div class="col-xs-8">
				...
				<div class="form-group">
			<label class="control-label col-xs-4">Nombres<span class="required">*</span></label>
			<div class="col-xs-8">
				<input type="text" required name="nombres" value="{{$attribute->nombres}}" maxlength="100" class="form-control  requiered">
			</div>
		</div> 
		<div class="form-group">
			<label class="control-label col-xs-4">Primer Apellido<span class="required">*</span></label>
			<div class="col-xs-8">
				<input type="text" required name="primer_apellido" value="{{$attribute->primer_apellido}}" maxlength="50" class="form-control  requiered">
			</div>
		</div> 
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<input required value="{{$attribute->correo_electronico}}" class="form-control requieredEmail  requiered" type="email" name="correo_electronico" class="form-control email_validado">
			</div>
		</div>
		<div class="form-group">
	...
	<div class="col-md-6 col-xs-12">	
		<div class="form-group">
			...
			<div class="col-xs-8">
				<input id="fecha_nacimiento" required name="fecha_nacimiento" value="{{$attribute->fecha_nacimiento}}" class="form-control requiered data-picker-until-today" autocomplete="off">
			</div>
		</div> 
		{{-- <div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				<input type="text" required name="direccion_residencia" id="direccion_residencia" data-pos="1" value="{{$attribute->direccion_residencia}}" class="form-control  direccion requiered">
			</div>
		</div>

		<div class="form-group">
			<label class="control-label col-xs-4">Teléfono Fijo<span class="required">*</span>
			</label>
			<div class="col-xs-8" style="font-size: 0;">
				<input type="text" name="telefono_residencia_indicativo" value="{{ $indicativo2->name }}" style="font-size: 13px !important;" maxlength="10" id="telefono_residencia_indicativo" maxlength="5" class="form-control  tl telefono_indicativo" readOnly>
				<input maxlength="10" required class="form-control requiered tlx numeric" style="font-size: 13px !important;" type="text" name="telefono_residencia" id="telefono_residencia" class="form-control " value="{{$attribute->telefono_residencia}}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8" style="font-size: 0;">
				<input type="text" name="telefono_celular_indicativo" value="{{ $indicativo1->name }}" style="font-size: 13px !important;" maxlength="10" id="telefono_celular_indicativo" maxlength="5" class="form-control  tl telefono_indicativo_celular" readOnly>
				<input maxlength="10" required class="form-control  requiered numeric tlx" style="font-size: 13px !important;" type="text" name="telefono_celular" id="telefono_celular" class="form-control" value="{{$attribute->telefono_celular}}">
			</div>
		</div>
...
@section('javascript')   
    ...
    URL.setAction("{{ url('/clientes/proveedor/persona/natural/update') }}");
    ...
    $(document).ready(function()
    {
      ...
      {{-- @for($j=0;$j<count($estudios);$j++)
            ...
            document.getElementsByName("fecha_inicio_estudios[]")[{{$j}}].value = "{{$estudios[$j]['fecha_inicio_estudio']}}";    
            document.getElementsByName("fecha_terminacion_estudios[]")[{{$j}}].value = "{{$estudios[$j]['fecha_terminacion_estudio']}}"; 
      ...
      {{-- @for($j=0;$j<count($hist_laboral);$j++)
            ...
            document.getElementsByName("fecha_ingreso_hist_laboral[]")[{{$j}}].value = "{{$hist_laboral[$j]['fecha_ingreso']}}"; 
            document.getElementsByName("fecha_retiro_hist_laboral[]")[{{$j}}].value = "{{$hist_laboral[$j]['fecha_retiro']}}"; 
	  ...
	  loadSelectInput("#id_pais_exp, #id_pais_residencia", "{{ url('/pais/getpais') }}", 2);
      ...
      $('#rh').val({{$attribute->rh}});
      $('#telefono_residencia').val({{$attribute->telefono_residencia}});
      $('#telefono_celular').val({{$attribute->telefono_celular}});
