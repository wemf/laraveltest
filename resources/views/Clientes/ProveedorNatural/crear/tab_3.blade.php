...
<table class="table" id="tbl_info_dias_estudio">
  ...
  <tbody>
    <tr>
      <td><input type="checkbox" class="check" name="estudio_lunes_persona" value="0"></td>
      <td><input type="checkbox" class="check" name="estudio_martes_persona" value="0"></td>
      <td><input type="checkbox" class="check" name="estudio_miercoles_persona" value="0"></td>
      <td><input type="checkbox" class="check" name="estudio_jueves_persona" value="0"></td>
      <td><input type="checkbox" class="check" name="estudio_viernes_persona" value="0"></td>
      <td><input type="checkbox" class="check" name="estudio_sabado_persona" value="0"></td>
      <td><input type="checkbox" class="check" name="estudio_domingo_persona" value="0"></td>
    </tr>
  </tbody>
</table>
<div class="center">
