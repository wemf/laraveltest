...
<div class="modal-styles confirm-hide modal-huella">
    <div class="shadow"></div>
    <div class="container">
        <div class="title">
            <h1 id="confirmtitle">Escanear Huella</h1>
        </div>
        <h3 class="segment">Coloque la huella del cliente en el lector biométrico</h3>
        <div class="buttons">
    ...
    <div class="x_content">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="col-md-4">
                    <div onclick="$('.modal-huella').addClass('confirm-visible').removeClass('confirm-hide');" class="btn btn-primary btn-img">
                        <img src="{{ asset('images/huella.png') }}" height="115px" alt="Escanear Huella">
                        <p>Escanear Huella</p>
                    </div>
                </div>
                <div class="col-md-4">
