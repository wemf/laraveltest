...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form id="form-attribute" action="{{ url('/calificacion/create') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="nombre" required="required" class="form-control col-md-7 col-xs-12" maxlength="25">
            </div>
          </div> 
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group">
                ...
                <input type="text" class="moneda form-control centrar-derecha" name="valor_min" id="valor_min" maxlength="15" aria-label="Amount (to the nearest dollar)" required="required">
              </div>
            </div>
          </div> 
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group">
                <span class="input-group-addon">$</span>
                <input type="text" class="moneda form-control centrar-derecha" name="valor_max" id="valor_max" maxlength="15" aria-label="Amount (to the nearest dollar)" required="required">
              </div>
            </div>
          </div>
      <div class="form-group">
