...
<div class="x_panel">
    <div class="x_title"><h2>Anular Guía</h2>
        @if($guia->id_estado != env('ESTADO_LOGISTICA_ANULADO'))
            <button type="button" class="btn btn-danger" id="id_anular_guia" data-toggle="modal" data-target=".bs-example-modal-lg" style="float: right;">Anular</button>
        @endif    
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="gridSystemModalLabel">Anular guía</h4>
                </div>
                            ...
                            <div class="col-md-10 bottom-20">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       ...
                                       <input type="hidden" name="destino" id="destino" value="{{ $guia->id_tienda }}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="anularConfir">Confirmar</button>
                </div>
            </div>
        </div>
    </div>
    <div class="x_content">
        ...
        <div class="x_title"><h2>Ordenes de resolucion</h2>
            <div class="clearfix"></div>
        </div>
