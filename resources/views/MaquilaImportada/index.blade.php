...
<div class="x_panel">
  <div class="x_title"><h2>Maquila Importada</h2>
...
@section('javascript')   
  ...
  //<script>    
    ...
    dtMultiSelectRowAndInfo('table_vitrina', "{{ url('/contrato/maquilaimportada/get') }}","{{url('/plugins/datatable/DataTables-1.10.13/json/spanish.json')}}",column)
    ...
    // var url2="{{ url('/contrato/maquilaimportada/procesar') }}/"+id_tienda+"/"+ordenes.slice(0,-1);
    ...
    ( contratos != "" ) ? location.href = urlBase.make('contrato/maquilaimportada/procesar/' + $('#col0_filter').val() + "/" + contratos) : Alerta( 'Alerta', 'Debe seleccionar por lo menos una orden', 'warning' );
  });
