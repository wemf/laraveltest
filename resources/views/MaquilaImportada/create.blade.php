...
<div class="col-md-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Ordenes de Maquila Importada</h2>
      ...
      <div class="x_content" id="cont_fran">
       ...
       {{-- <form id="from_proceso" method="POST" class="form-horizontal form-label-left" action="javascript:void(0)"> --}}
        <form id="from_proceso" method="POST" class="form-horizontal form-label-left" action="{{ url('/contrato/maquilaimportada/procesar') }}">
            {{ csrf_field() }}  
          ...
          <div class="form-group">
            <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-3">
              ...
              <input type="hidden" id="pros" name="pros" value="maquilaimportada">
