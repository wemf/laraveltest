...
<div class="x_panel">
  <div class="x_title">
    <h2>Asociaciones a Sociedades</h2>
    <div class="clearfix"></div>
  </div>
  <div class="x_content">
    <div class="btn-group pull-right espacio" role="group" aria-label="..." >
	    <a title="Nuevo Registro" href="{{ url('/asociarclientes/asociarsociedad/create') }}"  id="newAction" class="btn btn-primary hide"><i class="fa fa-pencil-square-o  "></i> </a>
	    <button title="Gestionar Sociedades"  id="updateAction1" type="button" class="btn btn-success"><i class="fa fa-pencil-square-o  "></i> Gestionar Sociedades</button>
...
@section('javascript')   
  @parent
   column=[   
  	...
  	dataTableActionFilter("{{url('/asociarclientes/asociarsociedad/get')}}","{{url('/plugins/datatable/DataTables-1.10.13/json/spanish.json')}}",column)

    $("#updateAction1").click(function() {
      var url2="{{ url('/asociarclientes/asociarsociedad/create') }}";
    ...
    loadloadSelectWithTextValue("#col5_filter","{{ url('/asociarclientes/asociarsociedad/getselectlisttipocliente') }}");
