  ...
  <div class="x_content">
                ...
                <div class="col-md-10 col-md-offset-1">
                  ...
                  <div class="col-md-6 bottom-20">
                      <div class="form-group">
                          ...
                          <div class="col-md-7 col-sm-6 col-xs-12">
                                @if($info_cliente != null)
                                    <input name="pais_expedicion" id="pais_expedicion" type="text" class="form-control numeric requiered resertInp" value="{{ $info_cliente->pais_expedicion }}" readonly>
                                @else
                                    <select id="pais_expedicion" name="pais_expedicion" class="form-control col-md-7 col-xs-12 requiered resertInp" onchange='loadSelectInputByParent("#ciudad_expedicion", "{{ url('/ciudad/getciudadbypais') }}", this.value, 1);'>
                                        <option value="">- Seleccione una opción -</option>
                                        @foreach($pais as $p)
                                            <option value="{{ $p->id }}">{{ $p->name }}</option>
                                        @endforeach    
                  ...
                  <div class="col-md-6 bottom-20">
                      <div class="form-group">
                          ...
                          <div class="col-md-7 col-sm-6 col-xs-12">
                                @if($info_cliente != null)
                                    <input name="ciudad_expedicion" id="ciudad_expedicion" type="text" class="form-control numeric requiered resertInp" value="{{ $info_cliente->ciudad_expedicion }}" readonly>
                                @else
                                    <select id="ciudad_expedicion" name="ciudad_expedicion" class="form-control col-md-7 col-xs-12 requiered resertInp">
                                        <option value="">- Seleccione una opción -</option>
                                    </select>
                                @endif    
                          </div>
                    ...
                    @if($info_cliente != null)
                        ...
                        <div class="col-md-6 bottom-20">
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-xs-12 bottom-20">
                                    <div class="row">
      ...
      <div class="col-lg-12 co-md-12 col-sm-12 col-xs-12 text-center btn-step" id="step-1Btn">
        ...
        <div id="step-2" style="display:none;">
            ...
            <div class="x_title"><h2>Items del plan separe</h2>
                <div class="clearfix"></div>
            </div>
      ...
      <div id="step-3" style="display:none;">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" name="abono_mayor" id="abono_mayor" class="moneda form-control requiered" readonly/>
                    </div>
                </div>
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    <label for="saldo_abonar_credito">Abono tarjeta de credito<span class="required red">*</span></label>
                    <div class="input-group">
                        <span class="input-group-addon">$</span>
                ...
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    <label for="comprobante_credito">Codigo de aprobación <span class="required red">*</span></label>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    <label for="saldo_abonar_debito">Abono tarjeta de debito<span class="required red">*</span></label>
                    <div class="input-group">
                        <span class="input-group-addon">$</span>
                ...
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    <label for="comprobante_debito">Codigo de aprobación <span class="required red">*</span></label>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    <label for="comprobante_otro">Codigo de aprobación <span class="required red">*</span></label>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="moneda form-control requiered centrar-derecha resertInp" name="abono" id="abono" />
                        <input type="hidden" name="codigo_plan_transferir" id="codigo_plan_transferir" value="{{ $codigo_plan_transferir }}" />
                        <input type="hidden" name="codigo_abono" id="codigo_abono" value="{{ $codigo_abono }}" />
                        <input type="hidden" name="id_tienda_transfer" id="id_tienda_transfer" value="{{ $id_tienda }}" />
                    </div>
                </div>
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
                    <label>Valor transferido <span class="required red">*</span></label>
                    <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="moneda form-control requiered centrar-derecha resertInp" name="saldo_transferido" id="saldo_transferido" readonly value="{{ $saldo_transferido }}"/>
                        <input type="hidden" name="val_tranfer" id="val_tranfer" />
                    </div>
                </div>
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="col-lg-6 co-md-6 col-sm-6 col-xs-12"  id="div_fecha_entrega" style="display:none;">
      ...
      <div style="margin-top: 0.5em !important">
        <div class="col-lg-12 co-md-12 col-sm-12 col-xs-12 text-center btn-step" id="step-2Btn" style="display:none;">
          ...
          <input type="button" title="Siguiente" class="btn btn-success" id="g2TransferirPlan" onclick="valProducto('step-2','step-3','step-2Btn','step-3Btn', 'st2', 'st3')" value="Siguiente">
        </div>
        <div class="col-lg-12 co-md-12 col-sm-12 col-xs-12 text-center btn-step" id="step-3Btn" style="display: none;">
          ...
          <input type="button" title="Guardar" class="btn btn-success" id="g3Transferir" value="Finalizar">
        </div>
      </div>
  </div>
</div>
