...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <div class="">
            ...
            <input type="text" id="id_tienda" style="border:0;color:white;color: transparent;overflow: hidden;width: 0;" value="{{ $id_tienda }}">
            <input type="text" id="saldo_favor" style="border:0;color:white;color: transparent;overflow: hidden;width: 0;" value="{{ $saldo_favor }}">
            <input type="text" id="codigo_plan" style="border:0;color:white;color: transparent;overflow: hidden;width: 0;" value="{{ $codigo_plan }}">
        </div>
    </div>
</div>
...
@push('scripts')
<script src="{{asset('/js/plansepare/validarclienteTransfer.js')}}"></script>
@endpush
