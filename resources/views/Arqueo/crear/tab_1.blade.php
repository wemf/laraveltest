...
<div class="row">	
	...
	<div class="col-md-6 col-xs-12">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">Informaci&oacute;n de la Tienda</span></label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			<label class="control-label col-xs-4">R&eacute;gimen de la Sociedad</span></label>
			<div class="col-xs-8">
	...
	<div class="col-md-6 col-xs-12">
		<!-- <div class="form-group">
			...
			<div class="col-xs-7">
			<input readOnly type="text" id="comprobante_arqueo" name="comprobante_arqueo" class="form-control" value='1'>        
			</div>
		</div> -->
		<div class="form-group">
...
<div class="row">
	<div class="x_title"><h2>Saldos del Sistema</h2><div class="clearfix"></div></div>
		<div class="form-group">
			<label class="control-label col-xs-2">Fecha Saldo Inicial</span></label>
			<div class="col-xs-8">
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <input readOnly type="text" class="moneda form-control centrar-derecha total_sistema" name="total_sistema" id="total_sistema" maxlength="15" aria-label="Amount (to the nearest dollar)" value="{{$total_sistema}}">
                </div>
            </div>
		</div>
