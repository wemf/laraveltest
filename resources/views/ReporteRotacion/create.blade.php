      ...
      <div class="x_content">
        ...
        <form id="form-attribute" action="{{ url('/pais/create') }}" method="POST" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="abreviatura" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input title="Solo se permiten indicativos desde 0 hasta 9999" min="0" max="9999" onKeyDown="limitText(this,3);" type="number" name="codigo_telefono" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>   
