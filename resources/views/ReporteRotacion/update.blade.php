      ...
      <div class="x_content">
        ...
        <form id="form-attribute" action="{{ url('pais/update') }}" method="POST" class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->abreviatura}}" maxlenght = "5" type="text" name="abreviatura" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input value="{{ $attribute->codigo_telefono}}" maxlenght = "4" type="text" name="codigo_telefono" required="required" class="form-control col-md-7 col-xs-12 justNumbers">
            </div>
          </div> 
