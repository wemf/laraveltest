...
<div class="col-md-6 col-md-offset-3">
    <div class="x_panel">
      <div class="x_title">
        <h2>Ingresar Día Festivo</h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <br />
        <form id="form-attribute" autocomplete="off" action="{{ url('/diasfestivos/create') }}" method="POST" class="form-horizontal form-label-left">
            {{ csrf_field() }}  
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" maxlength="70" name="fecha" required="required" id="fecha" value="" class="form-control col-md-7 col-xs-12 data-picker-only">
            </div>
          </div>           
