...
namespace App\AccessObject\Nutibara\Inventario\Trazabilidad;
...
class TrazabilidadAO
{
      public static function Create($request)
      {
            ...
            try{
                  DB::beginTransaction();
                  DB::table('tbl_trazabilidad')->insert($request['trazabilidad']);
                  DB::commit();
            }
            catch(Exception $e){
                  $response=false;	
	...
	public static function getCountTrazabilidad(){
            return DB::table('tbl_trazabilidad')
            ->count();
	}
}