...
namespace App\AccessObject\Nutibara\JoyaEspecial;
...
class JoyaEspecial 
{
	...
	public static function JoyaEspecialWhere($start,$end,$colum, $order,$search){
		return DB::table('tbl_orden')->join('tbl_orden_hoja_trabajo_cabecera', function($join)
								...
								->where('tbl_orden.proceso',env('PROCESO_JOYA_ESPECIAL'))
