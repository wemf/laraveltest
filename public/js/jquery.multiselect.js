...
(function($){
    var defaults = {
        ...
        // plugin texts
        texts: {
            placeholder    : 'Seleccione Opciones', // text to use in dummy input
            ...
            unselectAll    : 'Deseleccionar todos',   // unselect all text
            noneSelected   : 'No seleccionado'   // None selected text
        },
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div class="ms-options-wrap"><button class="form-control" style="border: 1px solid #ccc;"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
